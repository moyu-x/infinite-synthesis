...
type Config struct {
	...
	// save custom fiberzerolog logger.
	//
	// Optional. Default: fiberzerolog.New(os.Stderr).With().Timestamp().Logger()
	Logger *zerolog.Logger

	// GetLogger defines a function to get custom fiberzerolog logger.
	...
	// Use snake case for fields: FieldResBody, FieldQueryParams, FieldBytesReceived, FieldBytesSent, FieldRequestId,
	// FieldReqHeaders, FieldResHeaders.
	...
	//
	// Optional. Default: {fiberzerolog.ErrorLevel, fiberzerolog.WarnLevel, fiberzerolog.InfoLevel}
